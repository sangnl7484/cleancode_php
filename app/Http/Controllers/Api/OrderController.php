...
class OrderController extends Controller
{
    public function orderDetail(Request $request)
    {
        try {
            ...
            $data = [
                ...
                'created_at' => HelperAPI::formatDateTime($order->created_at),
                'updated_at' => HelperAPI::formatDateTime($order->updated_at),
                'list_status' => [
                    'unpaid',
                    'paid',
                    'cancelled',
    ...
    public function createOrder(Request $request)
    {
        try {
            ...
            if ($checkQuantityProduct) {
                return HelperAPI::responseError('Not enough product');
            } else {
                $orderData = [
                    ...
                    if (OrderDetail::create($orderDetail)) {
                        ...
                        foreach ($orderItems as $orderItem) {
                            ...
                            if (!OrderItem::create($orderItem)) {
                                ...
                                return HelperAPI::responseError();
                            }
                        }
                        return HelperAPI::responseSuccess();
                    } else {
    ...
    public function getOrderList(Request $request)
    {
        try {
            ...
            return HelperAPI::responseSuccess($query->get());
        } catch (\Throwable $e) {
            return HelperAPI::responseError($e->getMessage());
        }
    }
